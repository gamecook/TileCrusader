...
package com.gamecook.tilecrusader.sounds {
    ...
    public class TCSound {
		 ...
		 */
		public function TCSound(manager:SoundManager)
		{
		 ...
		 */
		public function loadEmbedded(EmbeddedSound:Class, Looped:Boolean=false):TCSound
		{
			stop();
			init();
		 ...
		 * @return	This <code>FlxSound</code> instance (nice for chaining stuff together, if you're into that).
		 */
		public function loadStream(SoundURL:String, Looped:Boolean=false):TCSound
		{
			stop();
			init();
			_sound = new Sound();
