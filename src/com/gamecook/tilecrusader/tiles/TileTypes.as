...
package com.gamecook.tilecrusader.tiles
{
    ...
    public class TileTypes
    {
		...
		TYPES['4'] = { name: 'Monster 4', sprite: "sprite10", type: MONSTER, classPath:"MonsterTile", pointPercent:".3"},
		TYPES['5'] = { name: 'Monster 5', sprite: "sprite11", type: MONSTER, classPath:"MonsterTile", pointPercent:".3"},
		TYPES['6'] = { name: 'Monster 6', sprite: "sprite12", type: MONSTER, classPath:"MonsterTile", pointPercent:".4"},
		TYPES['7'] = { name: 'Monster 7', sprite: "sprite13", type: MONSTER, classPath:"MonsterTile", pointPercent:".4"},
		TYPES['8'] = { name: 'Monster 8', sprite: "sprite14", type: MONSTER, classPath:"MonsterTile", pointPercent:".6"},
