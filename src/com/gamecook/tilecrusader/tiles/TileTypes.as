...
package com.gamecook.tilecrusader.tiles
{
    ...
    public class TileTypes
    {
		...
		TYPES['1'] = { name: 'Monster 1', sprite: "sprite7", life: 1, maxLife:1, attackRoll: 2, defenseRoll: 1, color: 0x009124, type: MONSTER, classPath:"MonsterTile"},
		TYPES['2'] = { name: 'Monster 2', sprite: "sprite8", life: 2, maxLife:2, attackRoll: 3, defenseRoll: 2, color: 0x014512, type: MONSTER, classPath:"MonsterTile"},
		TYPES['3'] = { name: 'Monster 3', sprite: "sprite9", life: 3, maxLife:3, attackRoll: 3, defenseRoll: 3, color: 0x669175, type: MONSTER, classPath:"MonsterTile"},
		TYPES['4'] = { name: 'Monster 4', sprite: "sprite10", life: 3, maxLife:3, attackRoll: 3, defenseRoll: 4, color: 0x7D7D7D, type: MONSTER, classPath:"MonsterTile"},
		TYPES['5'] = { name: 'Monster 5', sprite: "sprite11", life: 1, maxLife:1, attackRoll: 2, defenseRoll: 2, color: 0xE8E5C1, type: MONSTER, classPath:"MonsterTile"},
		TYPES['6'] = { name: 'Monster 6', sprite: "sprite12", life: 1, maxLife:1, attackRoll: 2, defenseRoll: 3, color: 0xF0E548, type: MONSTER, classPath:"MonsterTile"},
		TYPES['7'] = { name: 'Monster 7', sprite: "sprite13", life: 1, maxLife:1, attackRoll: 3, defenseRoll: 4, color: 0x736B00, type: MONSTER, classPath:"MonsterTile"},
		TYPES['8'] = { name: 'Monster 8', sprite: "sprite14", life: 4, maxLife:4, attackRoll: 4, defenseRoll: 4, color: 0x9193B5, type: MONSTER, classPath:"MonsterTile"},
		TYPES['9'] = { name: 'Monster 9', sprite: "sprite15", life: 6, maxLife:6, attackRoll: 4, defenseRoll: 4, color: 0x9193B5, type: BOSS, classPath:"MonsterTile"},
